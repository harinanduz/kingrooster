...
from kingrooster import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
from kingrooster import ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"kingrooster/modules/{shortname}.py")
        name = "kingrooster.modules.{}".format(shortname)
        ...
        mod.kingroosterbot = kingroosterbot
        mod.tbot = tbot
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["kingrooster.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "kingrooster/modules/*.py"
