...
@register(pattern=r"^/kingrooster(?: |$)([\s\S]*)")
async def _(event):
    if event.fwd_from:
        return
...
__help__ = """
**For text assistant**
 - /kingrooster <question>: Ask kingrooster any question and it will give accurate reply. For eg: `/kingrooster where is Taj Mahal`, `/kingrooster what is the age of Virat Kohli` etc..
**For voice assistant**
 - /kingrooster: Reply to a voice query and get the results in voice output (ENGLISH ONLY)

**Terminal Assistant**
 - /howdoi <question>: Get all coding related answers from kingrooster. Syntax: `/howdoi print hello world in python`
