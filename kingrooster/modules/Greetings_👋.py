...
from kingrooster import tbot, CMD_HELP
from kingrooster.modules.sql.welcome_sql import (
    add_welcome_setting,
...
import kingrooster.modules.sql.rules_sql as sql
...
# -- @Misskingrooster_Robot (sassiet captcha ever) --#
