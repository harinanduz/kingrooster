...
import heroku3
from kingrooster import OWNER_ID, tbot, UPSTREAM_REPO_URL


# UPSTREAM_REPO_URL = "https://github.com/sakhaavvaavaj93/kingrooster.git"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        await lol.edit("`Successfully Updated!\n" "restarting......`")
        args = [sys.executable, "-m", "kingrooster"]
