from kingrooster import tbot, ubot, CMD_HELP
...
async def _(event):
    ...
    packshortname = f"MisskingroosterRobot_sticker_{userid}"
    kanga = await event.reply("`Kanging .`")
    is_a_s = is_it_animated_sticker(reply_message)
    file_ext_ns_ion = "@MisskingroosterRobot.png"
    ...
    if is_a_s:
        ...
        packshortname = f"MisskingroosterRobot_animate_{userid}"
    ...
    os.system("rm -rf  @MisskingroosterRobot.png")
