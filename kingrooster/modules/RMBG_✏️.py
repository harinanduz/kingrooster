...
from kingrooster import REM_BG_API_KEY
from kingrooster import TEMP_DOWNLOAD_DIRECTORY
...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.reply(
            "remove.bg API returned Errors. Please report to @MisskingroosterRobotSupport\n`{}".format(
